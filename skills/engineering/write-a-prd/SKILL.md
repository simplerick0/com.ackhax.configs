...
A deep module (as opposed to a shallow module) is one which encapsulated a lot of funtionality in a simple, testable interface which rarely changes.

Check with the user that these modules match their expectations. Check with the user which modules they want tests writte for.
